...
public class ViewConfirmUser extends Activity {
    SQLiteDatabase db1;
            ...
            lst1.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    try {
                        ...
                        db1.execSQL(query11);
                        Toast.makeText(ViewConfirmUser.this,"User Registration Confirmed Sucessfully",Toast.LENGTH_LONG).show();
                        finish();
                        Intent i1= new Intent(ViewConfirmUser.this, ViewConfirmUser.class);
                        startActivity(i1);

                    }catch(Exception e){
                        Toast.makeText(ViewConfirmUser.this,""+e,Toast.LENGTH_LONG).show();
                    }
...
*/
            ...
            LevelAdapter l1 = new LevelAdapter(ViewConfirmUser.this, hname, contact, address);
            lst1.setAdapter(l1);
        }catch(Exception e){
            Toast.makeText(ViewConfirmUser.this,""+e,Toast.LENGTH_LONG).show();
        }
