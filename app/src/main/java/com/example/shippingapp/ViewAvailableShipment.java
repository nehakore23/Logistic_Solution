...
public class ViewAvailableShipment extends Activity {
    SQLiteDatabase db1;
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viewavailableshipment);
        ...
        try {
            ...
            lst1.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    try {
                        ...
                        db1.execSQL(query11);
                        Toast.makeText(ViewAvailableShipment.this,"Shipment Aceepted Sucessfully",Toast.LENGTH_LONG).show();
                        finish();
                        Intent i1= new Intent(ViewAvailableShipment.this,ViewAvailableShipment.class);
                        startActivity(i1);

                    }catch(Exception e){
                        Toast.makeText(ViewAvailableShipment.this,""+e,Toast.LENGTH_LONG).show();
                    }
            ...
            LevelAdapter l1 = new LevelAdapter(ViewAvailableShipment.this, hname, contact, address);
            lst1.setAdapter(l1);
        }catch(Exception e){
            Toast.makeText(ViewAvailableShipment.this,""+e,Toast.LENGTH_LONG).show();
        }
