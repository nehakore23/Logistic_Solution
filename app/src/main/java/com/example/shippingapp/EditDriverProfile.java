...
public class EditDriverProfile extends Activity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        SharedPreferences shr= PreferenceManager.getDefaultSharedPreferences(EditDriverProfile.this);
...
db1.execSQL(q1);
                      ...
                      //  db1.insert("userdata", null, cv1);
                        Toast.makeText(EditDriverProfile.this, "User Added Sucessfully", Toast.LENGTH_LONG).show();
                        finish();
                    }
                }catch(Exception e){
                    Toast.makeText(EditDriverProfile.this,"Exception"+e,Toast.LENGTH_LONG).show();
                }
            }
        });
    }
